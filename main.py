...
from_dir = "C:/WhiteHat jr/Classwork/class 114/testA"              # Add the path of you "Downloads" folder.
to_dir = "C:/WhiteHat jr/Classwork/class 114/testB" #Create "Document_Files" folder in your Desktop and update the path accordingly.
